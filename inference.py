...
用法:
    python inference.py --checkpoint checkpoints/stage1/checkpoint_epoch2_20260525_143208.pt --config configs/stage1_pretrain.yaml --temperature 0.6  --max_new_tokens 100
"""
